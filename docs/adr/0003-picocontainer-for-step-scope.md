...
Trident will run scenarios in parallel from Phase 2, and will later hold browser and driver
...
- Parallel execution needs no extra work: separate scenarios get separate object graphs, so
  Phase 2 does not have to revisit this.
...
Phase 2 enables parallel execution.
